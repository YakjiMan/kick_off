			...
			<div class="newspage">
				...
				<table class="titletag">
					<tr>
						...
						<td><a href="news.jsp?keyword=<%= tsearch_note %>&search_type=<%= search_type %>">더보기+</a></td>
					</tr>
				</table>
				<hr>
				<%
					...
					<table class="searchlist">
						<tr>	
							<td class="searchtitle">
								<a href="news_view.jsp?no=<%= vo.getPost_no() %>" ><%= title %></a>
							</td>
			...
			<div class="videopage">
				...
				<table class="titletag">
					<tr>
						...
						<td><a href="video.jsp?keyword=<%= tsearch_note %>&search_type=<%= search_type %>">더보기+</a></td>
					</tr>
				</table>
				<hr>
				<%
				for(PostVO vo : video)
				{
					...
					<table class="searchlist">
						<tr>	
							<td class="searchtitle">
								<a href="video_view.jsp?no=<%= vo.getPost_no() %>" ><%= title %></a>
							</td>
							<td rowspan="2" class="searchimage">
								<%
			...
			<div class="boardpage">
				...
				<table class="titletag">
					<tr>
						...
						<td><a href="board_list.jsp?keyword=<%= tsearch_note %>&search_type=<%= search_type %>">더보기+</a></td>
					</tr>
				</table>
				<hr>
				<%
				for(PostVO vo : board)
				{
					...
					<table class="searchlist">
						<tr>	
							<td class="searchtitle">
								<a href="board_view.jsp?no=<%= vo.getPost_no() %>" ><%= title %></a>
							</td>
						</tr>
						<tr>
