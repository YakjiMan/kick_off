...
<!-- main 시작 -->
		<div class="main">
			<div class="news_frame">
				<form id="write" enctype="multipart/form-data" method="post" action="news_writeok.jsp" onsubmit="return DoSave();">
				...
				<div class="clebutton"><a href="news.jsp?mcate=<%= mcate %>&sort=<%= sort %>&page=<%= pageno %>" class="button_text">취소</a></div>
				</form>
			</div>
		</div>
