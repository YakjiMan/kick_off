...
//	챔피언스리그 ajax 호출
	...
	{
		let date_url = "schedule_"+ mome +".jsp?fDate="+ sDate + "&eDate=" + eDate;
		$.ajax
		({
			type: "get",
			url: date_url,
				...
				<div class="slidewrap">
					<ul class="slidelist">
						...
						for(PostVO vo : main)
						{
							...
							%>
							<li class="slideitem">
							<a href="news_view.jsp?no=<%= vo.getPost_no() %>">
								<div class="textbox">
									<h3><%= title1 %></h3>
								</div>
							...
							<td>
								<table class="news_frame">
									<tr>
										...
										<td><a href="news_view.jsp?no=<%= vo.getPost_no() %>"><%= title %></a></td>
									</tr>
								</table>
							</td>
						<%
							...
							<tr>
								...
								for(PostVO vo : video)
								{
									...
									<div class="video_frame">
										<a href="video_view.jsp?no=<%= vo.getPost_no() %>">
											<%
										...
										<a href="video_view.jsp" class="video_title"><%= title %></a><br>
										...
										<tr>
											<td  class="table_ul"> 
												...
												for(PostVO vo : news2)
												{
													...
													%>
													<li><a href="news_view.jsp?no=<%= vo.getPost_no() %>"><%= title %></a></li>
													<%
												}
												%>
												</ul>
										...
										<tr>
											<td  class="table_ul">
												...
												for(PostVO vo : board)
												{
													...
													%>
													<li><a href="board_view.jsp?no=<%= vo.getPost_no() %>"><%= title %></a></li>
													<%
												}
												%>
												</ul>
						...
						<table class="bottom">
							<tr>
								...
								<td id="VT">
									...
									<div class="news_detail">
										<a href="result_schedule.jsp">더보기+</a>
									</div>
									<br><br><br>
