...
<!-- main 시작 -->
		<div class="main">
			<div class="news_frame">
				<form id="write" enctype="multipart/form-data" method="post" action="news_modifyok.jsp" onsubmit="return DoSave();">
				...
				<div class="clebutton"><a href="news_view.jsp?no=<%= no %>&mcate=<%= mcate %>&sort=<%= sort %>&page=<%= pageno %>" class="button_text">취소</a></div>
				</form>
			</div>
		</div>
