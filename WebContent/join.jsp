...
<html>
	...
	<script>
		...
		function DoSend()
		{
			$.ajax({
				type : "get",
				url: "send_mail.jsp?mail=" + $("#user_mail").val(),
				dataType: "html",
				success : function(data) 
				{
					data = data.trim()
		...
		function DoMailCheck()
		{
			$.ajax({
				type : "get",
				url: "check_mail.jsp?code=" + $("#codenumber").val(),
				dataType: "html",
				success : function(data) 
				{
					data = data.trim()
...
<!-- main 시작 -->
		...
		<div class="main">
			...
			<div class="loginbackground">
				<form class="join" name="join" method="post" id="join" action="joinok.jsp" >
				<table class="jointbl">
					<tr>
						<td>&nbsp;&nbsp;<b>아이디</b>
						<br>
					...
					<tr>
						<td colspan="2">
							<br>
							<input type="button" class="joinbutton" value="취소"  onclick="javascript:document.location='index.jsp';" >
						</td>
					</tr>					
				</table>
				</form>		
