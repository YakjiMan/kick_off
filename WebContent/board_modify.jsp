...
<!-- main 시작 -->
		<div class="main">
		<br>
		<form id="board_modify" enctype="multipart/form-data" method="post" action="board_modifyok.jsp?mcate=<%= mcate %>" onsubmit="return DoSubmit();">
			...
			<tr>
				<td>
					<table class="small_table1">
						<tr>
							<td class="board_title"><a href="board_list.jsp?no=1">자유게시판</a></td>
						</tr>
					</table>
					<hr class="horizon">
					...
					{
						%>
						기존 첨부파일 : <a href="board_down.jsp?no=<%= no %>"><%= vo.getPost_oname() %></a>
						<%
					}
					else
					{
